...
/**
 * Assembler for transforming Record domain entities into ReportResource representations.
 * <p>
...
public class ReportFromEntityAssembler {
    /**
     * Transforms a {@link Record} aggregate into a {@link ReportResource} for external consumption.
     ...
     *
     * @param entity The Record domain entity to transform.
     * @return The corresponding ReportResource.
     * @throws IllegalArgumentException if the entity is null.
     */
    public static ReportResource toResourceFromEntity(Record entity) { // Changed from Report to Record
        if (entity == null) {
