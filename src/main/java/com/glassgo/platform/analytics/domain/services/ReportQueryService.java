...
public interface ReportQueryService {
    ...
    /**
     * Handles a query to retrieve a report by its source identifier.
     * Returns an Optional to handle cases where no report is found for the given source ID.
     *
     * @param query the query containing the source ID criteria
